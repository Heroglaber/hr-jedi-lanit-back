...
import ru.lanit.bpm.jedu.hrjedi.adapter.restservice.dto.DownloadableFileDto;
import ru.lanit.bpm.jedu.hrjedi.adapter.restservice.dto.WorkbookDto;
import ru.lanit.bpm.jedu.hrjedi.adapter.restservice.dto.StreamedDto;
import ru.lanit.bpm.jedu.hrjedi.app.attendance.AttendanceService;
import ru.lanit.bpm.jedu.hrjedi.app.attendance.AttendanceReportService;
...
public class AttendanceController {
    ...
    @Autowired
    public AttendanceController(AttendanceService attendanceService, AttendanceReportService attendanceReportService) {
    ...
    public void downloadAttendanceReport(@RequestParam("month") Month month, @RequestParam("year") int year, HttpServletResponse response) {
        StreamedDto result = new WorkbookDto(attendanceReportService.createAttendanceReport(month, year));
